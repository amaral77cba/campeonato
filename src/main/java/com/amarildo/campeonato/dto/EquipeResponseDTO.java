...
public class EquipeResponseDTO {
    ...
    private String nomeEstadioPadrao;
    ...
    public String getNomeEstadioPadrao() {
        return nomeEstadioPadrao;
    }

    public void setNomeEstadioPadrao(String nomeEstadioPadrao) {
        this.nomeEstadioPadrao = nomeEstadioPadrao;
    }
}
